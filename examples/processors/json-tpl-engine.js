/**
 * @file mockJSON node 版
 *       基于 https://github.com/mennovanslooten/mockJSON 修改
 *       更多语法说明，参考 http://experiments.mennovanslooten.nl/2010/mockjson/
 *
 *       其它 mock 数据生成器，可以参考：
 *       http://chancejs.com/
 *       http://mockjs.com/
...
exports.generateFromTemplate = function (template, name) {
    var length = 0;
    ...
    switch (type(template)) {
        case 'array':
            ...
            for (var i = 0; i < length; i++) {
                generated[i] = exports.generateFromTemplate(template[0]);
            }
            break;
        ...
        case 'object':
            ...
            for (var p in template) {
                generated[p.replace(/\|(\d+-\d+|\+\d+)/, '')] = exports.generateFromTemplate(template[p], p);
